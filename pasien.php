...
<head>
    ...
    <title>Pasien</title>
    <!-- Bootstrap CSS -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-OPUBBU9d4uEhp75ZB6Zjx1HHnLf0CQgzKE4v7h5I2UIH35WOR/Mnfu5aJvP8bP8T" crossorigin="anonymous">
</head>
...
<body>
    <div class="container mt-4">
            ...
            <tbody>
                ...
                while ($data = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-success rounded-pill px-3" href="index.php?page=pasien&id=<?php echo $data['id']; ?>&aksi=ubah">Ubah</a>
        ...
        if (isset($_POST['update'])) {
            ...
            $update = mysqli_query($mysqli, "UPDATE pasien SET nama='$nama', alamat='$alamat', no_hp='$no_hp' WHERE id='$id'");
            echo "<script>document.location='index.php?page=pasien';</script>";
        }
